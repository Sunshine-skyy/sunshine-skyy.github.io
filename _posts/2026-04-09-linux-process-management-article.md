...
_图 3：fork() 之后会产生两个执行流，父子进程都从 fork() 的下一条语句开始执行。_
## 四、vfork 与 fork 的区别
...
![进程控制主线流程图](04-process-control-mainline.png)
_图 4：多数多进程程序都遵循“fork -> exec -> wait/waitpid”这条主线。_
...
这个区别一定要分清。
![孤儿进程与僵尸进程对比图]05-orphan-vs-zombie.png)
_图 5：孤儿进程是“子进程还活着但父进程没了”，僵尸进程是“子进程已经结束但父进程还没回收”。_
## 七、wait：阻塞方式回收子进程
...
_图 6：wait() 更简单，waitpid() 更灵活，尤其适合多个子进程或非阻塞回收场景。_
## 九、如何获取子进程的退出状态
