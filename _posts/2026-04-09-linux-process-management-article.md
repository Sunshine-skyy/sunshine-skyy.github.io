...
![可执行文件结构与进程内存结构](02-可执行文件结构与进程内存结构图.png)
...
![fork 创建子进程执行流程图](03-fork创建子进程执行流程图.png)
...
这个区别一定要分清。
![孤儿进程与僵尸进程对比图](05-孤儿进程与僵尸进程对比图.png)
...
就更适合使用 waitpid()。
![wait 与 waitpid 对比图](06-wait与waitpid对比图.png)
